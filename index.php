...
<div class="col-md-4 d-flex ftco-animate contact_icon_div">
...
<div class="text">
<h3>291 St. George St </h3>
<p>London, ON N6A3A8</p>
</div>
</div>
<div class="col-md-4 d-flex ftco-animate contact_icon_div">
<div class="icon"><lord-icon
...
<div class="icon d-flex justify-content-center align-items-center mb-5">
    ...
    trigger="loop"
    colors="primary:#e83a30,secondary:#fad1e6"
    style="width:250px;height:250px">
</lord-icon></div>
<div class="media-body">
...
<section class="ftco-appointment" id="contactUs">
<div class="overlay"></div>
<div class="container-wrap">
